...
for _, data in yaml_data.items():
    ...
    authors = [aut if aut != "me" else "<strong>Kevin G. Daly</strong>" for aut in authors]
    author_str = readable_list(authors)
    year_str = data["year"]

    buttons = []
    preprint = data.get("preprint")
    open_access = data.get("open_access_url")
    ...
    if working_paper:
        ...
        if open_access is not None:
            buttons.append(button(open_access, "Open Access", "ai-archive"))
        pub_strs["pubs"][year_str].append(
        "<li class='list-group-item'>" + pub_str + "<br>" + " ".join(buttons) + "<br>" + f{open_access} + "</li>"
         )
