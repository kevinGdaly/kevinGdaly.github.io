...
I am an Associate Professor at UCD's School of Agriculture and Food Science, where I lead the "Ruminant Palaeogenomics" group.
...
I am a postdoctoral researcher in the Ruminant Palaeogenomics group working on the PastureFuture project funded by BiOrbic. I am a computational biologist and my research aims to integrate ancient and modern livestock genomics with functional genetic data to identify variants that can improve sustainability and productivity in livestock, particularly focusing on disease resistance.

Previously, I completed my PhD in Infection Biology at University College Dublin with a thesis on integrative population and functional genomics of trypanotolerance in hybrid African cattle. Prior to that I completed an MSc in Evolutionary Biology, also at University College Dublin where I studied population genomics of the endangered Galway sheep breed, and an undergraduate degree in Natural Sciences at Trinity College Dublin, specialising in Zoology.
...
![](GillianMcHugo.jpg){width="100%" style="border-radius: 4px;"}
...
I am a doctoral student in the Ruminant Paleogenomics group, working within Kevin Daly’s HERDPATH ERC, to evaluate the impact of domestication and continued anthropogenic management on the genomic health of sheep and goats. 

I received my undergraduate degree from the University of Toronto, double majoring in Evolutionary Biology and Molecular Genetics, and minoring in Archaeology. During this time, I completed an independent research project (the Canadian approximation of a Bachelor’s thesis) within [the Wilde Lab](http://individual.utoronto.ca/wildelab/) focusing on characterizing isoforms of the structural actin protein in nematode worms. 

In the pursuit of synthesizing my research interests, and satiating an ever-present thirst for understanding the long intertwined relationships between humans and non-human animals, I undertook a Master's degree in Palaeogenetics at the University of Tübingen as part of the [ASHE program](https://uni-tuebingen.de/en/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/geowissenschaften/arbeitsgruppen/urgeschichte-naturwissenschaftliche-archaeologie/studium/akademische-studiengaenge/masters/msc-ashe/). Working in the [Posth Lab](https://uni-tuebingen.de/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/geowissenschaften/arbeitsgruppen/urgeschichte-naturwissenschaftliche-archaeologie/ina/archaeo-and-palaeogenetik/), I analyzed a set of wooly rhinoceros genomes from the species' poorly characterized western range, in order to understand its evolution and extinction. In this time, I became increasingly fascinated with the phenomenon of megaherbivore extinction and the ultimate (though arguably impartial) replacement of their ecological roles by agricultural humans, inclusive of the rise of domesticate ruminant populations. 
...
I am a PhD student in Kevin Daly’s Ruminant Palaeogenomics group at UCD, working on the ERC-funded HERDPATH project. I completed a BSc in Genetics and Genomics at the University of Galway, where I carried out a final-year research project in pathogen genomics with Professor Matthew Dorman, followed by an MSc in Genomic Medicine at Trinity College Dublin. My research focuses on the pathogen side of HERDPATH, using palaeogenomics to investigate the evolution of livestock pathogens and host–pathogen interactions in archaeological sheep and goat remains over time. I have had a long-standing interest in ancient DNA and look forward to developing this work within the group.
...
![](michael1.png){width="100%" style="border-radius: 4px;"}
...
![Roisin Ferguson](https://scholar.google.com/citations?user=w03pSp4AAAAJ&hl=en)

![Jolijn Erven](https://orcid.org/0000-0003-3620-8658)


## Group Photos

::: {layout-ncol=3}
![Cambridge 2026](group1.jpg){.lightbox group="gallery"}

![Escape Room 2026](group2.jpg){.lightbox group="gallery"}
